...
def generate_text(input_text, num_return_sequences=1):
    input_tokens = tokenizer.encode_plus(input_text, padding='max_length', return_tensors='pt')
    output_tokens = model.generate(input_tokens.input_ids, attention_mask=input_tokens.attention_mask, num_return_sequences=num_return_sequences, max_length=150)
